...
const ContactForm = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (Object.keys(validationErrors).length > 0) {
            ...
            emailjs
                .send(
                    "service_oloxx74", //  service ID
                    "template_t42ayz3", //  template ID
                    formData,
                    "SwKPJhAnA8Q1LYdlH" //  user/public key
                )
                .then(() => {
    ...
    return (
        <div className="p-4 lg:w-3/4" id="contact">
            ...
            onSubmit={handleSubmit}>
                ...
                <button
                    type="submit"
                    className={`mb-8 w-full rounded border border-stone-50/30 bg-stone-200 px-4 py-2 text-sm font-semibold text-stone-900 hover:bg-stone-300 ${isSending ? "opacity-50" : ""}`}
                    disabled={isSending}
                >
